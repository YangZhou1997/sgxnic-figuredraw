...
build/ARM/gem5.fast \
    --remote-gdb-port=0 \
    --outdir=/users/yangzhou/gem5/sgx_nic/m5out/DerivO3CPU_nat-tcp-v4_16kB \
    --stats-file=DerivO3CPU_nat-tcp-v4_16kB_stats.txt \
    ...
    > /users/yangzhou/gem5/sgx_nic/results/stdout_DerivO3CPU_nat-tcp-v4_16kB.out \
    2> /users/yangzhou/gem5/sgx_nic/stderr/stderr_DerivO3CPU_nat-tcp-v4_16kB.out
