...
build/ARM/gem5.fast \
    --remote-gdb-port=0 \
    --outdir=/users/yangzhou/GEM5_DRAMSim2/sgx_nic/m5out/detailed_maglev.dpi.acl-fw.monitoring.lpm.monitoring.lpm.lpm.monitoring.acl-fw.acl-fw.dpi.lpm.dpi.nat-tcp-v4.acl-fw_4MB_tp \
    --stats-file=detailed_maglev.dpi.acl-fw.monitoring.lpm.monitoring.lpm.lpm.monitoring.acl-fw.acl-fw.dpi.lpm.dpi.nat-tcp-v4.acl-fw_4MB_tp_stats.txt \
    ...
    > /users/yangzhou/GEM5_DRAMSim2/sgx_nic/results/stdout_detailed_maglev.dpi.acl-fw.monitoring.lpm.monitoring.lpm.lpm.monitoring.acl-fw.acl-fw.dpi.lpm.dpi.nat-tcp-v4.acl-fw_4MB_tp.out \
    2> /users/yangzhou/GEM5_DRAMSim2/sgx_nic/stderr/stderr_detailed_maglev.dpi.acl-fw.monitoring.lpm.monitoring.lpm.lpm.monitoring.acl-fw.acl-fw.dpi.lpm.dpi.nat-tcp-v4.acl-fw_4MB_tp.out
