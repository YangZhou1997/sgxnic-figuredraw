...
build/ARM/gem5.fast \
    --remote-gdb-port=0 \
    --outdir=/users/yangzhou/GEM5_DRAMSim2/sgx_nic/m5out/detailed_maglev.maglev.acl-fw.maglev.acl-fw.acl-fw.dpi.lpm.dpi.lpm.maglev.lpm.monitoring.acl-fw.maglev.nat-tcp-v4_4MB_tp \
    --stats-file=detailed_maglev.maglev.acl-fw.maglev.acl-fw.acl-fw.dpi.lpm.dpi.lpm.maglev.lpm.monitoring.acl-fw.maglev.nat-tcp-v4_4MB_tp_stats.txt \
    ...
    > /users/yangzhou/GEM5_DRAMSim2/sgx_nic/results/stdout_detailed_maglev.maglev.acl-fw.maglev.acl-fw.acl-fw.dpi.lpm.dpi.lpm.maglev.lpm.monitoring.acl-fw.maglev.nat-tcp-v4_4MB_tp.out \
    2> /users/yangzhou/GEM5_DRAMSim2/sgx_nic/stderr/stderr_detailed_maglev.maglev.acl-fw.maglev.acl-fw.acl-fw.dpi.lpm.dpi.lpm.maglev.lpm.monitoring.acl-fw.maglev.nat-tcp-v4_4MB_tp.out
