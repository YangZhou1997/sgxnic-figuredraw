...
build/ARM/gem5.fast \
    --remote-gdb-port=0 \
    --outdir=/users/yangzhou/GEM5_DRAMSim2/sgx_nic/m5out/detailed_monitoring.dpi.monitoring.lpm.maglev.nat-tcp-v4.acl-fw.lpm.acl-fw.dpi.dpi.dpi.lpm.nat-tcp-v4.nat-tcp-v4.acl-fw_4MB_tp \
    --stats-file=detailed_monitoring.dpi.monitoring.lpm.maglev.nat-tcp-v4.acl-fw.lpm.acl-fw.dpi.dpi.dpi.lpm.nat-tcp-v4.nat-tcp-v4.acl-fw_4MB_tp_stats.txt \
    ...
    > /users/yangzhou/GEM5_DRAMSim2/sgx_nic/results/stdout_detailed_monitoring.dpi.monitoring.lpm.maglev.nat-tcp-v4.acl-fw.lpm.acl-fw.dpi.dpi.dpi.lpm.nat-tcp-v4.nat-tcp-v4.acl-fw_4MB_tp.out \
    2> /users/yangzhou/GEM5_DRAMSim2/sgx_nic/stderr/stderr_detailed_monitoring.dpi.monitoring.lpm.maglev.nat-tcp-v4.acl-fw.lpm.acl-fw.dpi.dpi.dpi.lpm.nat-tcp-v4.nat-tcp-v4.acl-fw_4MB_tp.out
