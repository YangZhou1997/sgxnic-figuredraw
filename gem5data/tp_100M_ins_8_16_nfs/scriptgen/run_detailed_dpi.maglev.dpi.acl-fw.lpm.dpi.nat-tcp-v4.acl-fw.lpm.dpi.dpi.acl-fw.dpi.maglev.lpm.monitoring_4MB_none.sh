...
build/ARM/gem5.fast \
    --remote-gdb-port=0 \
    --outdir=/users/yangzhou/GEM5_DRAMSim2/sgx_nic/m5out/detailed_dpi.maglev.dpi.acl-fw.lpm.dpi.nat-tcp-v4.acl-fw.lpm.dpi.dpi.acl-fw.dpi.maglev.lpm.monitoring_4MB_none \
    --stats-file=detailed_dpi.maglev.dpi.acl-fw.lpm.dpi.nat-tcp-v4.acl-fw.lpm.dpi.dpi.acl-fw.dpi.maglev.lpm.monitoring_4MB_none_stats.txt \
    ...
    > /users/yangzhou/GEM5_DRAMSim2/sgx_nic/results/stdout_detailed_dpi.maglev.dpi.acl-fw.lpm.dpi.nat-tcp-v4.acl-fw.lpm.dpi.dpi.acl-fw.dpi.maglev.lpm.monitoring_4MB_none.out \
    2> /users/yangzhou/GEM5_DRAMSim2/sgx_nic/stderr/stderr_detailed_dpi.maglev.dpi.acl-fw.lpm.dpi.nat-tcp-v4.acl-fw.lpm.dpi.dpi.acl-fw.dpi.maglev.lpm.monitoring_4MB_none.out
