...
build/ARM/gem5.fast \
    --remote-gdb-port=0 \
    --outdir=/users/yangzhou/GEM5_DRAMSim2/sgx_nic/m5out/detailed_dpi.maglev.lpm.maglev.dpi.lpm.acl-fw.maglev.lpm.nat-tcp-v4.nat-tcp-v4.maglev.dpi.maglev.dpi.maglev_4MB_tp \
    --stats-file=detailed_dpi.maglev.lpm.maglev.dpi.lpm.acl-fw.maglev.lpm.nat-tcp-v4.nat-tcp-v4.maglev.dpi.maglev.dpi.maglev_4MB_tp_stats.txt \
    ...
    > /users/yangzhou/GEM5_DRAMSim2/sgx_nic/results/stdout_detailed_dpi.maglev.lpm.maglev.dpi.lpm.acl-fw.maglev.lpm.nat-tcp-v4.nat-tcp-v4.maglev.dpi.maglev.dpi.maglev_4MB_tp.out \
    2> /users/yangzhou/GEM5_DRAMSim2/sgx_nic/stderr/stderr_detailed_dpi.maglev.lpm.maglev.dpi.lpm.acl-fw.maglev.lpm.nat-tcp-v4.nat-tcp-v4.maglev.dpi.maglev.dpi.maglev_4MB_tp.out
