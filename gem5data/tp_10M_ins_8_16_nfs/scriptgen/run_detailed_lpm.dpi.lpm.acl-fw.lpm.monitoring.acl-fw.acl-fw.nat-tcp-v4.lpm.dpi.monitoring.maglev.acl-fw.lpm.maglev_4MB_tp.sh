...
build/ARM/gem5.fast \
    --remote-gdb-port=0 \
    --outdir=/users/yangzhou/GEM5_DRAMSim2/sgx_nic/m5out/detailed_lpm.dpi.lpm.acl-fw.lpm.monitoring.acl-fw.acl-fw.nat-tcp-v4.lpm.dpi.monitoring.maglev.acl-fw.lpm.maglev_4MB_tp \
    --stats-file=detailed_lpm.dpi.lpm.acl-fw.lpm.monitoring.acl-fw.acl-fw.nat-tcp-v4.lpm.dpi.monitoring.maglev.acl-fw.lpm.maglev_4MB_tp_stats.txt \
    ...
    > /users/yangzhou/GEM5_DRAMSim2/sgx_nic/results/stdout_detailed_lpm.dpi.lpm.acl-fw.lpm.monitoring.acl-fw.acl-fw.nat-tcp-v4.lpm.dpi.monitoring.maglev.acl-fw.lpm.maglev_4MB_tp.out \
    2> /users/yangzhou/GEM5_DRAMSim2/sgx_nic/stderr/stderr_detailed_lpm.dpi.lpm.acl-fw.lpm.monitoring.acl-fw.acl-fw.nat-tcp-v4.lpm.dpi.monitoring.maglev.acl-fw.lpm.maglev_4MB_tp.out
