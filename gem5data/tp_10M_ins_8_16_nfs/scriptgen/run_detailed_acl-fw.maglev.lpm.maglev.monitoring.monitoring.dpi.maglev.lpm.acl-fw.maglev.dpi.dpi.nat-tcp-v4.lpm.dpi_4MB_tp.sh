...
build/ARM/gem5.fast \
    --remote-gdb-port=0 \
    --outdir=/users/yangzhou/GEM5_DRAMSim2/sgx_nic/m5out/detailed_acl-fw.maglev.lpm.maglev.monitoring.monitoring.dpi.maglev.lpm.acl-fw.maglev.dpi.dpi.nat-tcp-v4.lpm.dpi_4MB_tp \
    --stats-file=detailed_acl-fw.maglev.lpm.maglev.monitoring.monitoring.dpi.maglev.lpm.acl-fw.maglev.dpi.dpi.nat-tcp-v4.lpm.dpi_4MB_tp_stats.txt \
    ...
    > /users/yangzhou/GEM5_DRAMSim2/sgx_nic/results/stdout_detailed_acl-fw.maglev.lpm.maglev.monitoring.monitoring.dpi.maglev.lpm.acl-fw.maglev.dpi.dpi.nat-tcp-v4.lpm.dpi_4MB_tp.out \
    2> /users/yangzhou/GEM5_DRAMSim2/sgx_nic/stderr/stderr_detailed_acl-fw.maglev.lpm.maglev.monitoring.monitoring.dpi.maglev.lpm.acl-fw.maglev.dpi.dpi.nat-tcp-v4.lpm.dpi_4MB_tp.out
