...
build/ARM/gem5.fast \
    --remote-gdb-port=0 \
    --outdir=/users/yangzhou/gem5/sgx_nic/m5out/DerivO3CPU_dpi-queue_2MB \
    --stats-file=DerivO3CPU_dpi-queue_2MB_stats.txt \
    ...
    > /users/yangzhou/gem5/sgx_nic/results/stdout_DerivO3CPU_dpi-queue_2MB.out \
    2> /users/yangzhou/gem5/sgx_nic/stderr/stderr_DerivO3CPU_dpi-queue_2MB.out
