...
build/ARM/gem5.fast \
    --remote-gdb-port=0 \
    --outdir=/users/yangzhou/gem5/sgx_nic/m5out/TimingSimpleCPU_maglev_2MB \
    --stats-file=TimingSimpleCPU_maglev_2MB_stats.txt \
    ...
    > /users/yangzhou/gem5/sgx_nic/results/stdout_TimingSimpleCPU_maglev_2MB.out \
    2> /users/yangzhou/gem5/sgx_nic/stderr/stderr_TimingSimpleCPU_maglev_2MB.out
